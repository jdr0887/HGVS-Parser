...
public class VariantMutation implements Serializable {
    ...
    public String toString() {
        return String.format("VariantMutation [accession=%s, range=%s, sequenceType=%s, changeType=%s, changeAction=%s]", accession, range,
